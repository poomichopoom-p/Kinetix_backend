...
const staffSchema = new mongoose.Schema(
    {
        ...
        email: {type:String,trim:true,minlength:4,maxlength:30,match:/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Unique:true},
        password:{typr:String, trim:true, select:false, minlength:4,maxlength:20,match:/^a/},
